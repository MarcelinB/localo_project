...
class SlotRepository extends ServiceEntityRepository
{
    ...
    public function findOneById($id): ?Slot
    {
    ...
    public function findOneByString($string): ?Slot
    {
        return $this->createQueryBuilder('s')
            ->andWhere('s.stringSlot = :string')
    ...
    public function findByFarm($farm)
    {
        return $this->createQueryBuilder('s')
            ->andWhere('s.farm = :farm')
